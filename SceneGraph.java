...
public class SceneGraph extends JPanel {
	 ...
	 *                       less than ytop, which will
	 *                       reverse the orientation of the y-axis to make the
	 ...
	 *                       the viewport; if it is true, then the limits will be
	 *                       expanded in one direction, horizontally or
	 *                       vertically, to make the aspect ratio of the displayed
	 *                       rectangle match the aspect ratio of the
	 *                       viewport. Note that when preserveAspect is false, the
	 *                       units of measure in the horizontal and
